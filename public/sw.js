const APP_CACHE = 'archive-repeat-app-v25'
const RUNTIME_CACHE = 'archive-repeat-runtime-v25'
const BASE_URL = new URL(self.registration.scope)
const BASE_PATH = BASE_URL.pathname.endsWith('/') ? BASE_URL.pathname : `${BASE_URL.pathname}/`
const APP_SHELL = [
  BASE_PATH,
  `${BASE_PATH}manifest.webmanifest?v=8`,
...
self.addEventListener('push', (event) => {
  let payload = { title: 'Sessions Repeat', body: 'لديك تحديث جديد', url: '/' }

...
comment on function public.restore_platform_backup_v1(jsonb) is
  'Atomic restore helper for Sessions Archive logical backups. Callable only by service_role through the secured backup Edge Function.';

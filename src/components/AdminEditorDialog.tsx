    ...
    try {
      switch (activeTarget.type) {
        ...
        case 'video': {
          ...
          if (!source) throw new Error(ar ? 'أدخلي رابطًا صالحًا من YouTube أو Google Drive أو WhatsApp أو Telegram.' : 'Enter a valid YouTube, Google Drive, WhatsApp, or Telegram URL.')
          await onSave(activeTarget, {
            title: String(form.get('title') || '').trim(),

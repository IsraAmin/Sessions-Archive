  ...
  return <div className="workspace-shell">
    ...
    <aside className={`app-sidebar ${sidebarOpen ? 'is-open' : ''}`}>
      <div className="sidebar-brand">
        <NavLink to="/" className="brand-lockup"><span className="brand-mark"><img src={logoUrl} alt="" aria-hidden="true" /></span><span><strong>أرشيف</strong><small>ريبيت</small></span></NavLink>
    ...
    <div className="workspace-main">
      <header className="workspace-topbar">
        <div className="topbar-start"><div className="mobile-brand"><img src={logoUrl} alt="" aria-hidden="true" /><span>أرشيف ريبيت</span></div></div>

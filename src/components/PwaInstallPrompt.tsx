...
export function PwaInstallPrompt() {
  ...
  const copy = language === 'ar' ? { label: 'تثبيت التطبيق', title: 'ثبّت Sessions Repeat', hint: iosHint ? 'على iPhone أو iPad: افتح المشاركة ثم اختر «إضافة إلى الشاشة الرئيسية».' : 'افتح المنصة كتطبيق مستقل من الشاشة الرئيسية.', install: 'تثبيت التطبيق', dismiss: 'إخفاء اقتراح التثبيت' } : { label: 'Install app', title: 'Install Sessions Repeat', hint: iosHint ? 'On iPhone or iPad: open Share, then choose “Add to Home Screen”.' : 'Open the platform as a standalone app from your home screen.', install: 'Install app', dismiss: 'Dismiss install suggestion' }

...
export function errorMessage(error: unknown) {
  ...
  if (typeof error === 'object' && error !== null) {
    ...
    if (code === '23505') return 'هذه القيمة مستخدمة من قبل. غيّري الاسم أو الـ Slug ثم حاولي مرة أخرى.'
    if (code === '23514') return 'إحدى القيم لا تطابق شروط الحفظ. تأكدي من الـ Slug والتاريخ والسعة ثم حاولي مرة أخرى.'

...
const ar = {
  'nav.sessions': 'الجلسات', 'nav.dashboard': 'لوحتي', 'nav.profile': 'الملف الشخصي', 'nav.admin': 'الإدارة',
  ...
  'sessions.eyebrow': 'تعلّم • شارك • تطور', 'sessions.title': 'اكتشف الجلسة المناسبة لك',
  'sessions.subtitle': 'ابحث بالعنوان أو الوصف أو التصنيف أو اسم المتحدث، وسجّل مباشرة من المنصة.',
  'sessions.placeholder': 'ابحث عن جلسة أو متحدث…', 'sessions.allCategories': 'كل التصنيفات', 'sessions.noResults': 'لا توجد نتائج مطابقة. جرّب كلمة أو تصنيفًا مختلفًا.',
  'sessions.loading': 'جاري تحميل الجلسات…', 'sessions.details': 'عرض التفاصيل', 'sessions.general': 'عام', 'sessions.speakerLater': 'متحدث يحدد لاحقًا',
  ...
  'details.register': 'سجل في الجلسة', 'details.unregister': 'إلغاء التسجيل', 'details.bookmark': 'حفظ', 'details.unbookmark': 'إزالة من المحفوظات',
  'details.rating': 'تقييمك', 'details.stars': 'النجوم', 'details.comment': 'تعليق', 'details.saveRating': 'حفظ التقييم',
  'details.resources': 'المصادر', 'details.resourceLogin': 'سجل الدخول لفتح ملفات الجلسة.', 'details.recordingAvailable': 'التسجيل متاح',
  'details.watchHere': 'شاهد الجلسة هنا', 'details.mainRecording': 'التسجيل الرئيسي', 'details.part': 'الجزء {n}',
  ...
  'details.registeredToast': 'تم التسجيل في الجلسة.', 'details.unregisteredToast': 'تم إلغاء التسجيل.', 'details.savedToast': 'تم حفظ الجلسة.',
  'details.unsavedToast': 'تمت إزالة الجلسة من المحفوظات.', 'details.feedbackToast': 'تم حفظ تقييمك.', 'details.calendarToast': 'تم تنزيل ملف التقويم.',
  'video.progress': 'شاهدت {n}%', 'video.continue': 'كمل المشاهدة من {time}', 'video.completed': 'اكتملت المشاهدة',
  'dashboard.eyebrow': 'لوحة المتابعة', 'dashboard.title': 'لوحتي', 'dashboard.registrations': 'تسجيلات', 'dashboard.bookmarks': 'محفوظات',
  'dashboard.feedback': 'تقييمات', 'dashboard.progress': 'فيديوهات بدأت', 'dashboard.registered': 'الجلسات المسجل بها',
  'dashboard.noRegistered': 'لم تسجل في جلسات بعد. اكتشف جلسة تناسبك وابدأ من هناك.', 'dashboard.continueWatching': 'كمل المشاهدة',
  ...
  'profile.deviceNotifications': 'إشعارات هذا الجهاز', 'profile.pushOn': 'الإشعارات مفعّلة. ستصلك تحديثات الجلسات على هذا الجهاز.',
  'profile.pushDenied': 'المتصفح يمنع الإشعارات. غيّر الإذن من إعدادات الموقع ثم حاول مرة أخرى.', 'profile.pushUnsupported': 'هذا المتصفح لا يدعم إشعارات الدفع.',
  'profile.pushOff': 'فعّل الإشعارات لتصلك تحديثات الجلسات حتى عندما لا تكون الصفحة مفتوحة.', 'profile.enablePush': 'تفعيل الإشعارات', 'profile.disablePush': 'إيقاف الإشعارات',
  ...
  'notifications.title': 'الإشعارات', 'notifications.markAll': 'تحديد الكل كمقروء', 'notifications.empty': 'لا توجد تحديثات جديدة. ستظهر هنا تغييرات الجلسات والتسجيلات.',
  'notifications.unread': '{n} غير مقروء', 'notifications.open': 'فتح الإشعارات', 'notifications.reminderTitle': 'الجلسة تبدأ قريبًا',
  ...
  'admin.users': 'المستخدمون', 'admin.sessions': 'الجلسات', 'admin.registrations': 'التسجيلات', 'admin.speakers': 'المتحدثون',
  'admin.analytics': 'التحليلات', 'admin.userManagement': 'إدارة المستخدمين', 'admin.series': 'سلاسل الجلسات', 'admin.content': 'المحتوى',
  'admin.superOnly': 'هذه الأدوات متاحة للمشرف الأعلى فقط.', 'admin.promote': 'ترقية إلى مشرف', 'admin.demote': 'سحب صلاحية المشرف', 'admin.disable': 'تعطيل الحساب', 'admin.enable': 'إعادة تفعيل الحساب',
  'admin.roleAdmin': 'مشرف', 'admin.roleStudent': 'طالب', 'admin.superAdmin': 'مشرف أعلى', 'admin.lastSignIn': 'آخر دخول', 'admin.activity': 'النشاط',
  ...
  'admin.createSession': 'إنشاء جلسة', 'admin.titleField': 'العنوان', 'admin.description': 'الوصف', 'admin.date': 'الموعد', 'admin.capacity': 'السعة', 'admin.noCategory': 'بدون تصنيف',
  'admin.noSpeaker': 'بدون متحدث', 'admin.noSeries': 'بدون سلسلة', 'admin.seriesPosition': 'رقم الجزء', 'admin.cover': 'غلاف', 'admin.resource': 'ملف',
  'admin.youtube': 'تسجيلات YouTube', 'admin.youtubeHint': 'الصق رابط الفيديو بعد رفعه على YouTube. سيظهر للطلاب داخل صفحة الجلسة.', 'admin.videoSession': 'الجلسة',
  ...
  'admin.push': 'إرسال إشعار', 'admin.pushTitle': 'العنوان', 'admin.pushBody': 'النص', 'admin.pushPath': 'المسار داخل التطبيق', 'admin.sendPush': 'إرسال الإشعار',
} as const

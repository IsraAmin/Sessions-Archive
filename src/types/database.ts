...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      session_videos: {
        Row: { id: string; session_id: string; title: string; youtube_video_id: string; video_provider: 'youtube' | 'google_drive' | 'whatsapp'; part_number: number; position: number; created_at: string; updated_at: string }
        Insert: { id?: string; session_id: string; title: string; youtube_video_id: string; video_provider?: 'youtube' | 'google_drive' | 'whatsapp'; part_number?: number; position?: number; created_at?: string; updated_at?: string }
      ...
      events: {
        Row: { id: string; title: string; slug: string; description: string; event_type: 'cultural' | 'sports' | 'initiative' | 'social' | 'academic' | 'other'; event_date: string; location: string | null; drive_folder_url: string | null; cover_url: string | null; cover_focus_x: number | null; cover_focus_y: number | null; featured: boolean; status: 'draft' | 'published'; created_by: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; title: string; slug: string; description?: string; event_type?: 'cultural' | 'sports' | 'initiative' | 'social' | 'academic' | 'other'; event_date: string; location?: string | null; drive_folder_url?: string | null; cover_url?: string | null; cover_focus_x?: number | null; cover_focus_y?: number | null; featured?: boolean; status?: 'draft' | 'published'; created_by?: string | null; created_at?: string; updated_at?: string }
        Update: { id?: string; title?: string; slug?: string; description?: string; event_type?: 'cultural' | 'sports' | 'initiative' | 'social' | 'academic' | 'other'; event_date?: string; location?: string | null; drive_folder_url?: string | null; cover_url?: string | null; cover_focus_x?: number | null; cover_focus_y?: number | null; featured?: boolean; status?: 'draft' | 'published'; created_by?: string | null; created_at?: string; updated_at?: string }
        Relationships: []
      }
      event_media: {
      ...
      competition_details: {
        Row: { event_id: string; competition_kind: 'problem_solving' | 'hackathon' | 'ctf' | 'innovation' | 'other'; organizer: string | null; phase: 'announced' | 'registration' | 'in_progress' | 'judging' | 'completed'; registration_opens_at: string | null; registration_closes_at: string | null; competition_starts_at: string | null; competition_ends_at: string | null; participation_mode: 'individual' | 'team' | 'both'; min_team_size: number | null; max_team_size: number | null; attendance_mode: 'in_person' | 'online' | 'hybrid'; eligibility: string | null; registration_url: string | null; rules_url: string | null; prizes: string | null; tracks: string | null; results_published: boolean; results_published_at: string | null; created_at: string; updated_at: string }
        Insert: { event_id: string; competition_kind?: 'problem_solving' | 'hackathon' | 'ctf' | 'innovation' | 'other'; organizer?: string | null; phase?: 'announced' | 'registration' | 'in_progress' | 'judging' | 'completed'; registration_opens_at?: string | null; registration_closes_at?: string | null; competition_starts_at?: string | null; competition_ends_at?: string | null; participation_mode?: 'individual' | 'team' | 'both'; min_team_size?: number | null; max_team_size?: number | null; attendance_mode?: 'in_person' | 'online' | 'hybrid'; eligibility?: string | null; registration_url?: string | null; rules_url?: string | null; prizes?: string | null; tracks?: string | null; results_published?: boolean; results_published_at?: string | null; created_at?: string; updated_at?: string }
        Update: { event_id?: string; competition_kind?: 'problem_solving' | 'hackathon' | 'ctf' | 'innovation' | 'other'; organizer?: string | null; phase?: 'announced' | 'registration' | 'in_progress' | 'judging' | 'completed'; registration_opens_at?: string | null; registration_closes_at?: string | null; competition_starts_at?: string | null; competition_ends_at?: string | null; participation_mode?: 'individual' | 'team' | 'both'; min_team_size?: number | null; max_team_size?: number | null; attendance_mode?: 'in_person' | 'online' | 'hybrid'; eligibility?: string | null; registration_url?: string | null; rules_url?: string | null; prizes?: string | null; tracks?: string | null; results_published?: boolean; results_published_at?: string | null; created_at?: string; updated_at?: string }
        Relationships: [{ foreignKeyName: 'competition_details_event_id_fkey'; columns: ['event_id']; isOneToOne: true; referencedRelation: 'events'; referencedColumns: ['id'] }]
      }
      competition_stages: {
        Row: { id: string; event_id: string; title: string; stage_at: string | null; description: string | null; position: number; created_at: string }
        Insert: { id?: string; event_id: string; title: string; stage_at?: string | null; description?: string | null; position?: number; created_at?: string }
        Update: { id?: string; event_id?: string; title?: string; stage_at?: string | null; description?: string | null; position?: number; created_at?: string }
        Relationships: [{ foreignKeyName: 'competition_stages_event_id_fkey'; columns: ['event_id']; isOneToOne: false; referencedRelation: 'events'; referencedColumns: ['id'] }]
      }
      competition_winners: {
        Row: { id: string; event_id: string; rank: number | null; award_title: string | null; entry_name: string; members: string | null; project_title: string | null; prize: string | null; project_url: string | null; image_url: string | null; position: number; created_at: string; updated_at: string }
        Insert: { id?: string; event_id: string; rank?: number | null; award_title?: string | null; entry_name: string; members?: string | null; project_title?: string | null; prize?: string | null; project_url?: string | null; image_url?: string | null; position?: number; created_at?: string; updated_at?: string }
        Update: { id?: string; event_id?: string; rank?: number | null; award_title?: string | null; entry_name?: string; members?: string | null; project_title?: string | null; prize?: string | null; project_url?: string | null; image_url?: string | null; position?: number; created_at?: string; updated_at?: string }
        Relationships: [{ foreignKeyName: 'competition_winners_event_id_fkey'; columns: ['event_id']; isOneToOne: false; referencedRelation: 'events'; referencedColumns: ['id'] }]
      }
      notifications: {

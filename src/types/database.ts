...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      sessions: {
        Row: { id: string; title: string; slug: string; description: string; category_id: string | null; speaker_id: string | null; starts_at: string; ends_at: string | null; location: string | null; capacity: number; cover_path: string | null; status: string; created_by: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; title: string; slug: string; description: string; category_id?: string | null; speaker_id?: string | null; starts_at: string; ends_at?: string | null; location?: string | null; capacity?: number; cover_path?: string | null; status?: string; created_by?: string | null; created_at?: string; updated_at?: string }
        Update: { id?: string; title?: string; slug?: string; description?: string; category_id?: string | null; speaker_id?: string | null; starts_at?: string; ends_at?: string | null; location?: string | null; capacity?: number; cover_path?: string | null; status?: string; created_by?: string | null; created_at?: string; updated_at?: string }
        Relationships: [
      ...
      registrations: {
        Row: { id: string; user_id: string; session_id: string; created_at: string }
        Insert: { id?: string; user_id: string; session_id: string; created_at?: string }
        Update: { id?: string; user_id?: string; session_id?: string; created_at?: string }
